...
class Employee_Exception extends Exception {
	private static final long serial= 10000;
...
public class Lab4_3 {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            emp.display();
            emp.writeToFile("C:\\Users\\Raghav.Kaushal\\git\\Testing\\Jan23_2026\\src\\test\\java\\package_1\\employee.txt");
            System.out.println("\nEmployee details written to file.");
 
            Employee empFromFile = Employee.readFromFile("C:\\Users\\Raghav.Kaushal\\git\\Testing\\Jan23_2026\\src\\test\\java\\package_1\\employee.txt");
