...
public class Lab5_3_4_5 {
	...
	public static void main(String[] args) {
		...
		driver.findElement(By.id("input-firstname")).sendKeys("Sunny");
		driver.findElement(By.id("input-lastname")).sendKeys("Paji");
		driver.findElement(By.id("input-email")).sendKeys("bfcvhvtgftydvk@mail.com");
		...
		boolean subs = driver
				.findElement(By.xpath(
						"/html/body/div[2]/div[1]/div[1]/form/fieldset[3]/div[1]/div[1]/label/input[@value='1']"))
				.isSelected();
		if (subs) {
			System.out.println("yes is selected");
		} else {
			driver.findElement(
					By.xpath("/html/body/div[2]/div[1]/div[1]/form/fieldset[3]/div[1]/div[1]/label/input[@value='1']"))
					.click();
		}
		...
		reg.selectByContainsVisibleText("Gujarat");
		driver.findElement(By.cssSelector(".btn.btn-primary")).click();
